...
if __name__ == "__main__":
    #main()
    df = pd.read_parquet("Processed_AIS_2024/Concatenated/01_2022.parquet")
    print(df.columns)
    ...
    df_small.to_parquet("Processed_AIS_2024/Cleaned/01_old_clean_2022.parquet", index=False)
